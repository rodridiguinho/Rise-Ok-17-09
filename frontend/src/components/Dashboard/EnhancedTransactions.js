...
const EnhancedTransactions = () => {
  ...
  const timezoneDB = {
    ...
    "Imperatriz": { timezone: "America/Fortaleza", utc: -3, country: "Brasil" },
    "Juazeiro do Norte": { timezone: "America/Fortaleza", utc: -3, country: "Brasil" },
    "Petrolina": { timezone: "America/Recife", utc: -3, country: "Brasil" },
    "Dourados": { timezone: "America/Campo_Grande", utc: -4, country: "Brasil" },
    "Corumbá": { timezone: "America/Campo_Grande", utc: -4, country: "Brasil" },
    "Rondonópolis": { timezone: "America/Cuiaba", utc: -4, country: "Brasil" },
    "Alta Floresta": { timezone: "America/Cuiaba", utc: -4, country: "Brasil" },
